...
public abstract class Personnage 
{
	...
	public String boirePotion()
	{
		...
		{
			this.vie = this.vie + 2;
			return "\nVous réccupérer de la vie. Votre vie est actuellement à "+this.vie+" pts.";
		}
		else
		{
			return "\nVous ne pouvez pas récupérer plus de points de vie. Votre vie est actuellement à "+this.vie+" pts.";
		}
	}
	...
	public String manger()
	{
		if(this.energie < MAX_ENERGIE)
		{
			...
			return "\nVous récupérer de l'énergie. Votre énergie est actuellement à "+this.energie+" pts.";
		}
		else
		{
			return "\nVous ne pouvez pas récupérer plus de points d'énergie. Votre énergie est actuellement à "+this.energie+" pts.";
		}
